...
Helpers = {
  ...
  */
  totalOutstandingContributionAmount: function(accountId, inactive) {
    ...
    if (!_.isUndefined(account)) {
      ...
      d_('account.contributions', account.contributions);
      _.map(account.contributions, function(contributionIdArr) {

        _.map(contributionIdArr, function(contributionId) {
          ...
          if (!_.isUndefined(contribution)) {
            if (inactive) {
              ...
              if (_.isNull(contribution.dateActivated)) {
                d_('summing');
                sumTotal += contribution.amountOutstanding;
              }
            }
            else {
              sumTotal += contribution.amountOutstanding;
